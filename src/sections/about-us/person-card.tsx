...
const PersonCard = ({ index, image, name, designation }: PersonCardProps) => (
  <div className="xs:w-[250px] w-[200px] cursor-pointer">
    <motion.div
    ...
    >
      <div
        ...
        id="card"
      >
        <div className='w-[100%] h-[26.5vh] relative'><Image fill={true} className="w-[100%] h-[100%] rounded-3xl object-cover" src={image} alt={image} /></div>
        <div
