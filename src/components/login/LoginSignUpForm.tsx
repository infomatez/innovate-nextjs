        ...
        <div className="container mx-auto px-4 py-10 h-full">
          <div className="flex flex-wrap -mx-2 justify-center">
            <div className="w-[85%] md:w-2/5 xl:w-1/4 px-2 flex flex-col  items-center">
              <div className="mb-10">
                <p className="text-white text-[24px] md:text-[35px] font-normal font-poppins text-center">
                  {userAction === LoginEnums.LOGIN ? 'Welcome,' : 'Create Account'}
                </p>
                <p className="text-[#B8B8B8] text-[24px] md:text-[35px] font-extralight font-poppins text-center">
                  {userAction === LoginEnums.LOGIN ? 'Glad to see you!' : 'to get started now!'}
                </p>
              </div>
              <form className="w-full" onSubmit={handleSubmit(handleFormSubmit)}>
                <div className="flex flex-col gap-4 items-center">
                  <div className="relative w-full">
                    ...
                    />
                    {errors.username && (
                      <span className="text-red-600 text-start w-full text-xs md:text-sm mt-1">
                  ...
                  <div className="relative flex flex-col w-full">
                      ...
                      {...register('password', {
                        ...
                        validate: {
                          length: (value) =>
                            ...
                            'Password must contain at least one capital letter, one special character, and be at least 7 characters long',
                        },
                      })}
                    />
                    ...
                    <EyeIcon
                      ...
                      onClick={() => setTogglePasswordField((state) => !state)}
                    />
                    {userAction === LoginEnums.LOGIN && (
                      <p className="text-grey-300 ml-2 font-poppins font-light text-lg self-end mt-2 cursor-pointer">
                        Forgot Password?
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex items-center p-2 border-[0.6px] border-white rounded-sm w-fit self-start">
                    ...
                    <label htmlFor="recaptcha" className="ml-2 font-poppins text-white font-medium text-xs ">
                      I’am not a robot
                    </label>
                  ...
                  >
                    {userAction === LoginEnums.SIGN_UP ? 'Sign up' : 'Login'}
                  </button>
                </div>
              </form>
              ...
              <p className="font-light font-poppins text-grey-300 text-sm md:text-lg mt-5 text-center">
                Don’t have any account?
                <span
                  className="ml-1 cursor-pointer font-medium font-poppins text-white text-sm md:text-lg"
                  onClick={() => setUserAction(userAction === LoginEnums.LOGIN ? LoginEnums.SIGN_UP : LoginEnums.LOGIN)}
                >
                  {userAction === LoginEnums.LOGIN ? 'Sign Up Now' : 'Login Now'}
                </span>
              </p>
            </div>
          </div>
