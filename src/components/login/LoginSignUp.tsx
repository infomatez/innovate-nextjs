      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-2 justify-center">
          <div className="w-full md:w-1/3 px-2 flex flex-col  items-center">
            <Image src="/byteBlogger1.png" alt="logo image" width={658} height={164} className="w-full h-auto mb-14" />
            <motion.button
            ...
            <button
              className="text-white text-[24px] font-light font-poppins mt-14 hover:opacity-70 transition-all duration-500 ease-in-out"
              onClick={() => router.push(PATH_DASHBOARD.dashboard)}
            >
              Continue as a guest
            </button>
          </div>
