                            ...
                            <div className="flex md:items-center">
                                <div className="mt-2 mr-2">
                                    <svg width="25" className="w-[20px] h-[20px] md:w-[45px] md:h-[45px]" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M18.5138 8.07617C18.5138 6.48487 17.8817 4.95875 16.7564 3.83353C15.6312 2.70831 14.1051 2.07617 12.5138 2.07617C10.9225 2.07617 9.39637 2.70831 8.27115 3.83353C7.14594 4.95875 6.51379 6.48487 6.51379 8.07617C6.51379 15.0762 3.51379 17.0762 3.51379 17.0762H21.5138C21.5138 17.0762 18.5138 15.0762 18.5138 8.07617Z" stroke="#bf02b5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M14.2438 21.0762C14.068 21.3792 13.8157 21.6308 13.512 21.8057C13.2084 21.9806 12.8642 22.0726 12.5138 22.0726C12.1634 22.0726 11.8192 21.9806 11.5156 21.8057C11.212 21.6308 10.9596 21.3792 10.7838 21.0762" stroke="#bf02b5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </div>
                                <div>
