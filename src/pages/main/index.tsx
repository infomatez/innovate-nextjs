                            ...
                            <div className="flex flex-col gap-1 flex-1">
                                <div className="flex items-start md:flex-row flex-col ml-0 gap-3 md:items-start flex-1 ">
                                    ...
                                    <div className='flex-1 items-start flex'>
                                        <div
                                            className={`border-solid border-white bg-white flex flex-col w-auto shrink-0 h-4 items-center py-1 border  w-2/5  h-[20px] rounded cursor-pointer ${isFollowing ? 'bg-gray-200' : ''
                                                }`}
